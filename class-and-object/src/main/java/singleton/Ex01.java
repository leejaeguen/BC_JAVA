...
public class Ex01 {
    public static void main(String[] args) {
         ...
         *   2. 인스턴스가 절대적으로 한 개만 할당 되는 것을 보증할 수 있다.(feat. 같은 주소)
         *  단점
         *   1. 싱글톤 인스턴스가 너무 많은 일을 하거나 많은 데이터를 공유하면 결함도가 높아져서 병목현상을
         *      유발할 수 있다.
        ...
        * */
        ...
        /* 설명. hashCode는 다른 객체인데 같은 값이 나오는 경우도 있다. 그럴땐 System.identityHashCode  */
        System.out.println("eager1의 주소" + System.identityHashCode(eager));
